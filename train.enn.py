...
def train_model(model: EvidenceNeuralNetwork, epoch, train_loader, optimizer, wandb_run: wandb.wandb_sdk.wandb_run.Run, max_epochs):
    # train_epoch()
    model.train()
...
def main():
    ...
    parser.add_argument('--name', type=str, required=True, help='experiment name', default='enn')
    parser.add_argument('--note', type=str, default='runs based on enn', help='experiment name')
